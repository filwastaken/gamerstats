...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { careerTotalGames: @stat.careerTotalGames, clanName: @stat.clanName, clanTag: @stat.clanTag, currentLevelXPProtoss: @stat.currentLevelXPProtoss, currentLevelXPTerran: @stat.currentLevelXPTerran, currentLevelXPZerg: @stat.currentLevelXPZerg, displayName: @stat.displayName, games1vs1: @stat.games1vs1, games2vs2: @stat.games2vs2, games3vs3: @stat.games3vs3, games4vs4: @stat.games4vs4, gamesArchon: @stat.gamesArchon, highest1v1Rank: @stat.highest1v1Rank, highestTeamRank: @stat.highestTeamRank, id: @stat.id, level: @stat.level, levelProtoss: @stat.levelProtoss, levelTerran: @stat.levelTerran, levelZerg: @stat.levelZerg, primaryRace: @stat.primaryRace, profilePath: @stat.profilePath, protossWins: @stat.protossWins, realm: @stat.realm, region: @stat.region, seasonId: @stat.seasonId, seasonNumber: @stat.seasonNumber, seasonTotalGames: @stat.seasonTotalGames, seasonYear: @stat.seasonYear, terranWins: @stat.terranWins, totalGamesThisSeason: @stat.totalGamesThisSeason, totalLevelXPProtoss: @stat.totalLevelXPProtoss, totalLevelXPTerran: @stat.totalLevelXPTerran, totalLevelXPZerg: @stat.totalLevelXPZerg, totalPointsAchievements: @stat.totalPointsAchievements, wins1vs1: @stat.wins1vs1, wins2vs2: @stat.wins2vs2, wins3vs3: @stat.wins3vs3, wins4vs4: @stat.wins4vs4, winsArchon: @stat.winsArchon, zergWins: @stat.zergWins } }
    end
