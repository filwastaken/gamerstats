class BattlenetOauthService
    ...
    def self.ottieniProfilo(access_token, profileId)
        puts "inizio|||||||____|_|__|_|_|_|_|_|_|_||_|__"
        profileId = 51
        regionIds = ["2"]
        realmIds = ["1","2"]
        regionIds.each do |region|
            realmIds.each do |realm|
                puts "#{region} #{realm} #{profileId}"
        ...
        puts "fine|||||||____|_|__|_|_|_|_|_|_|_||_|__"
    end
