Feature: Inserimento di un nuovo Team
  ...
  Scenario: Inserimento di un nuovo Team valido
    ...
    And I fill in "team_giocatore1" with "1"
  ...
  Scenario: Inserimento di un nuovo Team con gli stessi giocatori di un altro team
    Given a team exists with giocatore1: "1", giocatore2: "51"
    And I am on the new team page
    When I fill in "nome_team" with "myTeamB"
    And I fill in "Giocatore 1" with "1"
    And I fill in "Giocatore 2" with "51"
    And I press "submit"
  ...
  Scenario: Inserimento di un nuovo Team con lo stesso nome di un altro team
    Given a team exists with nome_team: "myTeam"
    And I am on the new team page
    When I fill in "nome_team" with "myTeam"
    And I fill in "Giocatore 1" with "1"
    And I fill in "Giocatore 2" with "151"
    And I press "submit"
  ...
  Scenario: Inserimento di un nuovo Team con giocatori duplicati
    ...
    When I fill in "nome_team" with "myTeamC"
    And I fill in "Giocatore 1" with "1"
    And I fill in "Giocatore 2" with "1"
    And I press "submit"
  ...
  Scenario: Inserimento di un nuovo Team con giocatori non esistenti nel gioco
    Given I am on the new team page
    When I fill in "nome_team" with "myTeamD"
    And I fill in "Giocatore 1" with "1"
    And I fill in "Giocatore 2" with "2"
    And I press "submit"
